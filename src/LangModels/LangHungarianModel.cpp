...
#define HungarianUnicodeAlphabetWidth         64
#define HungarianUnicodeCharToOrderIsReduced  0


#define HungarianOrderMatrixWidth         (IRR + 1)
...
const LanguageModel HungarianModel =
{
  ...
  HungarianUnicodeAlphabetWidth,
  HungarianUnicodeCharToOrderIsReduced,
  HungarianOrderMatrixWidth,
