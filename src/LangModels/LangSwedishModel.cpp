...
/* Model Table:
 * Number of web pages processed for this model: 1388
 * Number of characters consumed for this model: 4114387
 * Total considered sequences: 1438 / 900
 *
 * - Positive sequences: first 535 (0.9950461835094256)
 * - Probable sequences: next 208 (743-535) (0.003955118085057219)
 * - Neutral sequences: last 157 (0.00099869840551714)
...
static const PRUint8 SwedishFrequentCharMapping[] =
{
...
static const PRUint8 SwedishCompactedLangModel[] =
{
  ...
  0,3,3,3,3,3,3,3,3,3,2,3,3,3,3,3,3,3,2,2,3,3,3,3,3,2,2,1,1,2,0,
...
const SequenceModel Iso_8859_1SwedishModel =
{
  ...
  SwedishFrequentCharMapping,
  SwedishCompactedLangModel,
  30,
  (float)0.9990013015944829,
  PR_TRUE,
  "ISO-8859-1",
  "sv"
};
...
const LanguageModel SwedishModel =
{
  ...
  30,
  5,
  (float)0.4411843125111955,
  21,
  (float)0.031112775730625243,
  (float)0.9993782791944461,
};
