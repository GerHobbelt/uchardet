...
/* Model Table:
 * Number of web pages processed for this model: 884
 * Number of characters consumed for this model: 4084948
 * Total considered sequences: 1439 / 900
 *
 * - Positive sequences: first 577 (0.9950290822574802)
 * - Probable sequences: next 251 (828-577) (0.003975325481496372)
 * - Neutral sequences: last 72 (0.0009955922610234147)
 * - Negative sequences: -539 (off-ratio, TODO)
 */
...
static const PRUint8 MalteseFrequentCharMapping[] =
{
...
const SequenceModel Iso_8859_3MalteseModel =
{
  ...
  MalteseFrequentCharMapping,
  MalteseCompactedLangModel,
  30,
  (float)0.9990044077389766,
  PR_TRUE,
  "ISO-8859-3",
  "mt"
};
...
const LanguageModel MalteseModel =
{
  ...
  30,
  5,
  (float)0.4674409564087474,
  23,
  (float)0.03320213623282353,
  (float)0.9981284951485307,
};
