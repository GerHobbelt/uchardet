...
#define FinnishUnicodeAlphabetWidth         58
#define FinnishUnicodeCharToOrderIsReduced  0


#define FinnishOrderMatrixWidth         (IRR + 1)
...
const LanguageModel FinnishModel =
{
  ...
  FinnishUnicodeAlphabetWidth,
  FinnishUnicodeCharToOrderIsReduced,
  FinnishOrderMatrixWidth,
