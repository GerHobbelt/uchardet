...
#define GeorgianUnicodeAlphabetWidth         66
#define GeorgianUnicodeCharToOrderIsReduced  0


#define GeorgianOrderMatrixWidth         (IRR + 1)
...
const LanguageModel GeorgianModel =
{
  ...
  GeorgianUnicodeAlphabetWidth,
  GeorgianUnicodeCharToOrderIsReduced,
  GeorgianOrderMatrixWidth,
