...
static const unsigned char Iso_8859_2_CharToOrderMap[] =
{
  ...
  SYM, 58,SYM, 35,SYM, 62, 49,SYM,SYM, 22, 42, 70, 73,SYM, 23, 61, /* BX */
    5,  1, 38, 48, 32, 67, 29, 36, 21,  2, 55, 46, 52,  3, 45, 74, /* CX */
   37, 53, 66,  0,  0, 51, 31,SYM, 43, 59, 15, 75, 30, 41, 76, 39, /* DX */
    5,  1, 38, 48, 32, 67, 29, 36, 21,  2, 55, 46, 52,  3, 45, 77, /* EX */
   37, 53, 66,  0,  0, 51, 31,SYM, 43, 59, 15, 78, 30, 41, 79,SYM, /* FX */
};
...
static const unsigned char Iso_8859_16_CharToOrderMap[] =
{
  ...
  SYM,SYM, 21, 35, 23,SYM,SYM,SYM, 23, 21, 34,SYM, 60, 60, 71, 61, /* BX */
   40,  1, 38, 48, 32, 29, 47, 36,  2,  2,  2, 46,  3,  3, 45, 69, /* CX */
   37, 53,  0,  0,  0, 51, 31, 49, 82, 15, 15, 68, 30, 55, 64, 39, /* DX */
   40,  1, 38, 48, 32, 29, 47, 36,  2,  2,  2, 46,  3,  3, 45, 69, /* EX */
   37, 53,  0,  0,  0, 51, 31, 49, 83, 15, 15, 68, 30, 55, 64, 71, /* FX */
};
/* X0  X1  X2  X3  X4  X5  X6  X7  X8  X9  XA  XB  XC  XD  XE  XF */
...
static const unsigned char Windows_1250_CharToOrderMap[] =
{
  ...
  SYM,SYM,SYM, 35,SYM,SYM,SYM,SYM,SYM, 58, 42,SYM, 62,SYM, 62, 61, /* BX */
    5,  1, 38, 48, 32, 67, 29, 36, 21,  2, 55, 46, 52,  3, 45, 86, /* CX */
   37, 53, 66,  0,  0, 51, 31,SYM, 43, 59, 15, 87, 30, 41, 88, 39, /* DX */
    5,  1, 38, 48, 32, 67, 29, 36, 21,  2, 55, 46, 52,  3, 45, 89, /* EX */
   37, 53, 66,  0,  0, 51, 31,SYM, 43, 59, 15, 90, 30, 41, 91,SYM, /* FX */
};
/* X0  X1  X2  X3  X4  X5  X6  X7  X8  X9  XA  XB  XC  XD  XE  XF */
...
static const unsigned char Ibm852_CharToOrderMap[] =
{
  ...
  SYM,  1, 17, 20, 12,  2, 24, 18, 19,  3,  9, 11,  6, 14,  4,  0, /* 6X */
   13, 28,  5,  7,  8, 15, 10, 26, 27, 25, 16,SYM,SYM,SYM,SYM,CTR, /* 7X */
   36, 30,  2, 38, 32, 59, 29, 36, 35, 46, 51, 51, 45, 92, 32, 29, /* 8X */
  ...
  SYM,SYM,SYM,SYM,SYM,SYM, 48, 48,SYM,SYM,SYM,SYM,SYM,SYM,SYM,SYM, /* CX */
   37, 37, 94, 46, 95, 66,  3, 45, 52,SYM,SYM,SYM,SYM, 96, 59,SYM, /* DX */
...
/* Model Table:
 * Number of web pages processed for this model: 1097
 * Number of characters consumed for this model: 4128772
 * Total considered sequences: 1241 / 625
 *
 * - Positive sequences: first 456 (0.9950393343806435)
 * - Probable sequences: next 167 (623-456) (0.003967076503349598)
 * - Neutral sequences: last 2 (0.0009935891160068877)
...
static const PRUint8 SloveneFrequentCharMapping[] =
{
...
static const PRUint8 SloveneCompactedLangModel[] =
{
  ...
  0,3,3,3,3,3,3,3,3,3,3,2,3,
  3,2,2,3,3,2,3,3,3,3,3,2,3,
  
  0,3,3,3,3,3,3,3,3,3,3,3,3,
  3,3,3,3,3,3,3,3,3,3,3,3,3,
  
  0,3,3,3,3,3,2,3,3,3,3,3,3,
  3,3,3,3,2,3,3,2,3,2,2,3,3,
  
  0,3,3,3,3,3,3,3,3,3,2,3,3,
  2,3,3,3,2,3,2,3,3,2,1,1,2,
  
  0,3,3,3,3,3,3,3,3,3,3,3,3,
  2,2,3,3,3,2,2,3,2,1,1,1,2,
  
  0,3,3,3,3,3,2,2,3,2,1,3,3,
  3,3,3,3,3,3,2,3,3,2,3,1,1,
  
  0,3,3,3,3,3,3,3,3,3,3,1,3,
  3,3,2,3,3,3,3,2,3,3,3,2,1,
  
  0,3,3,3,3,3,3,3,3,3,3,3,2,
  3,2,3,3,1,1,2,2,3,1,2,1,1,
  
  0,3,3,3,3,3,3,3,3,3,3,3,3,
  3,3,3,3,3,3,3,2,2,1,3,3,2,
  
  0,3,3,3,3,3,3,3,3,3,2,1,2,
  2,3,2,3,2,2,1,3,2,2,2,1,2,
  
  0,3,3,3,3,3,3,3,3,2,2,2,3,
  2,3,3,3,2,3,2,1,3,3,3,1,2,
  
  0,3,3,3,3,3,3,3,3,3,3,3,3,
  3,3,3,2,3,3,3,3,3,3,3,3,3,
  
  0,3,3,3,3,3,3,3,3,2,3,3,3,
  3,3,3,3,2,3,3,3,2,2,3,2,1,
  
  0,3,3,3,3,3,3,3,3,2,3,2,2,
  3,1,3,3,2,2,1,2,2,3,2,1,3,
  
  0,3,3,3,3,3,3,3,2,2,1,2,1,
  2,1,3,3,1,1,2,3,1,1,2,1,1,
  
  0,3,3,3,3,3,3,3,2,3,1,2,3,
  1,1,3,3,2,1,1,1,1,2,1,0,2,
  
  0,3,3,3,3,2,3,3,2,3,1,3,3,
  2,1,2,3,2,2,1,3,3,0,0,0,1,
  
  0,3,3,3,3,3,3,3,1,1,3,1,3,
  1,1,1,3,1,2,1,0,1,0,0,1,0,
  
  0,3,3,3,3,3,1,3,1,3,3,3,3,
  1,3,2,2,0,1,0,1,1,3,1,0,0,
  
  0,3,3,3,3,3,2,2,0,0,3,1,3,
  1,1,1,3,1,3,2,0,2,1,1,0,0,
  
  0,3,3,3,3,2,3,3,3,3,2,1,1,
  1,1,1,3,1,1,1,1,2,0,1,1,3,
...
const SequenceModel Iso_8859_2SloveneModel =
{
  ...
  SloveneFrequentCharMapping,
  SloveneCompactedLangModel,
  25,
  (float)0.9990064108839931,
  PR_FALSE,
  "ISO-8859-2",
  "sl"
};
...
const LanguageModel SloveneModel =
{
  ...
  25,
  3,
  (float)0.40263666775496443,
  19,
  (float)0.03512061213358355,
  (float)0.9963049545966693,
};
