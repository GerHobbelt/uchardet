...
#define RomanianUnicodeAlphabetWidth         62
#define RomanianUnicodeCharToOrderIsReduced  0


#define RomanianOrderMatrixWidth         (IRR + 1)
...
const LanguageModel RomanianModel =
{
  ...
  RomanianUnicodeAlphabetWidth,
  RomanianUnicodeCharToOrderIsReduced,
  RomanianOrderMatrixWidth,
